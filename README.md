...
- Step 1: Cleaning and transformation: The following is the transformation code written in Python to transform the data into desired state and test locally.
...
- Step 2: Storage:
   Load the data into google cloud storage bucket. Methods to upload data in a bucket can be found in the below link.
...
- Step 2: ETL Orchestration - Mage 
   - [Data Loader](https://github.com/Pushpen-Joshi/project-uber-taxi/blob/88822d0d464b11007d2e7776faf8f3124ab7ed1c/Mage/uber-data-loader.ipynb):
      This code block fetches the data from the google cloud storage bucket and ready the data for the next transformation step. The output of this code block would be used as input for the next transformation block.
   ...
   - [Export](https://github.com/Pushpen-Joshi/project-uber-taxi/blob/88822d0d464b11007d2e7776faf8f3124ab7ed1c/Mage/uber-data-extract.ipynb):
      This code block uses the output of the transform block as input and exports the data into Google BigQuery dataset for further analysis.
...
<img width="722" alt="image" src="https://github.com/Pushpen-Joshi/project-uber-taxi/assets/112235293/0b00ff28-d656-4266-88fc-1b7287abd5c9">
